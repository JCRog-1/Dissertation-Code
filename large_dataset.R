...
####
#####
#The following code below is necessary for plotting graphs in the respective Kendall.Analysisand others, file
...
planar_dist_from_border_ao <- function(incorrectlabels){
  ...
  closest_distance <- apply(triangles,MARGIN = 1,FUN = function(x) (norm(x,type = '2')^2 - 1))
